...
public class RelacionPanel extends javax.swing.JPanel {

    private ConexionDB db;

    public RelacionPanel(ConexionDB db) {
        initComponents();
        this.db = db;
        setBaseDatos();
    }
    
    public RelacionPanel(ConexionDB db, String[] a, String nomDB) {
        initComponents();
        this.db = db;
        jLabel5.setText(a[3]);
        jLabel9.setText(a[2]);
        jLabel10.setText(a[0]);
        jLabel11.setText(a[1]);
    }
    
    public void setBaseDatos() {
        jLabel9.setText(db.nombreDB());
    }
